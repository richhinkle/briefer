...
SECTION_SPECS: dict[str, SectionSpec] = {
    ...
    "qrcode": SectionSpec(
        "qrcode", "QR code",
        "Print a QR code from text, a URL, or WiFi credentials (no key needed).",
        fields=[
            Field("mode", "Mode", "select", "text",
                  "What kind of QR code to generate.",
                  choices=("text", "wifi")),
            Field("data", "Data (text/URL)", "text",
                  help="The text or URL to encode (used in 'text' mode)."),
            Field("label", "Label", "text",
                  help="Optional caption printed above the QR code."),
            Field("ssid", "WiFi SSID", "text",
                  help="Network name (used in 'wifi' mode)."),
            Field("password", "WiFi password", "secret",
                  help="Network password (used in 'wifi' mode)."),
            Field("security", "Security type", "select", "WPA",
